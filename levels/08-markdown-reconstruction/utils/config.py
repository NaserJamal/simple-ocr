"""
Configuration constants for markdown reconstruction system
"""
...
# API settings for text extraction (markdown)
OCR_MAX_TOKENS = 8000
OCR_TEMPERATURE = 0.0

# API settings for markdown reconstruction
RECONSTRUCTION_MAX_TOKENS = 16000
RECONSTRUCTION_TEMPERATURE = 0.2
