...
class SectionDetector:
    ...
    def __init__(self, prompt_file: str = PROMPT_FILE, section_request: str = None):
    ...
    def detect_sections(self, img_base64: str, page_num: int) -> List[Dict]:
        ...
        try:
            if self.section_request:
                # User specified a particular section to find
                user_prompt = (
                ...
                # Default behavior: detect all major sections
                user_prompt = (
